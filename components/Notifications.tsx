...
const Notifications = () => {
    ...
    const unreadNotifications = inboxNotifications.filter((notifications) => !notifications.readAt)
                            ...
                            kinds={{
                                ...
                                $documentAccess: (props) => (
                                    <InboxNotification.Custom
                                     {...props} title={props.inboxNotification.activities[0].data.title} 
                                     aside={
                                     <InboxNotification.Icon className='bg-transparent'>
                                        <Image alt='avatar' width={36} height={36} className='rounded-full' src={props.inboxNotification.activities[0].data.avatar as string || ''}/>
